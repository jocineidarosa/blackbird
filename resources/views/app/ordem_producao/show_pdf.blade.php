...
<body>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="th-title pr-2 text-right" colspan="3">SITUAÇÃO</td>
                    <td class="pl-2" colspan="2">{{ $ordem_producao->status->nome }}</td>
                    <td colspan="3" class="th-title"></td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td colspan="6" class="text-left th-title">{{$ordem_producao->produto->nome}}</td>
                ...
                <tr>
                    ...
                    <td class="pl-2" style="width: 6rem;" colspan="2">{{ number_format($op_horimetro_inicial, 2) }}
                    </td>
                    <td class="text-right th-title pr-2" style="width: 10rem;" colspan="2">QUANTIDADE</td>
                    <td class="text-right th-title pr-2" colspan="2"> {{ str_replace(',', '.', number_format($ordem_producao->quantidade_producao, 0)) }}
                ...
                <tr>
                    ...
                    <td class="pl-2" colspan="2">{{ str_replace(',', '.', number_format($producao_por_hora, 0)) }}</td>
