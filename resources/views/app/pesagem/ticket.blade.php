...
<body>
    ...
    <!-- ---------------------------- -->
    {{-- evita que imprima mais que 3 tickets --}}
    @php
        if ($quant_impress > 3){
            $quant_impress=3;
        } 
            ...
            <tr class="td-bordered" style="background-color: rgb(183, 183, 183);">
                <td colspan="4" class="title">
                    <div style="display: flex; padding: 4px;">
                        <div style="width: 30%;">
                            <div>
                                {{-- <img src="{{asset('img/logo_bresol1.png') }}"> --}}
                                <img src="{{ asset('img/logo_bresola.png') }}" alt="" class="px-3">
                            </div>
                        </div>
            ...
            <tr class="td-bordered label">
                <td colspan="4">
                    <div style="display: flex;">
                        ...
                        <div style="width: 70%;">
                            <div class="div-label-left">{{ $pesagem->placa }} &nbsp;&nbsp;&nbsp;Sequencia&nbsp;&nbsp;{{$pesagem->sequencia}}</div>
                            <div class="div-label-left">{{ $pesagem->parceiro_id }} - {{ $pesagem->parceiro->nome }}
                            </div>
                        ...
                        <div style="width: 10%;">
                            <div class="div-label-left">{{ Carbon\Carbon::parse($pesagem->data)->format('d/m/Y') }}
                            </div>
            ...
            <tr class="td-bordered label">
                <td colspan="4">
                    <div style="display: flex;">
                        ...
                        <div style="width: 90%;">
                            <div class="div-label-left">{{ $pesagem->motorista_id }} - {{ $pesagem->motorista->nome }}
                            </div>
                        </div>
                    </div>
            ...
            <tr class="td-bordered label">
                <td colspan="3" class="td-bordered">
                    <div style="display: flex;">
                        ...
                        <div style="width: 90%;">
                            <div class="div-label-left">{{ $pesagem->produto_id }} - {{ $pesagem->produto->nome }}
                            </div>
                        </div>
                    </div>
                </td>
            ...
            <tr class="label">
                <td class="td-bordered">
                    <div style="display: flex;">
                        ...
                        <div style="width: 50%;" class="div-label-left">
                            {{ str_replace(',', '.', number_format($pesagem->peso_bruto, 0)) }}</div>
                    </div>
                </td>
                <td class="td-bordered">
                    <div style="display: flex;">
                        ...
                        <div style="width: 50%;" class="div-label-left">
                            {{ Carbon\Carbon::parse($pesagem->data_bruto)->format('d/m/Y') }}</div>
                    </div>
                </td>
                <td class="td-bordered">
                    <div style="display: flex;">
                ...
                <th class="td-bordered" rowspan="2">
                    <div>
                        ...
                        <div style="font-size: 25px; font-weight: 300; font-family: 'DS-Digital', sans-serif;">
                            {{ str_replace(',', '.', number_format($pesagem->peso_liquido, 0)) }}</div>
                    </div>
                </th>
            ...
            <tr class="label">
                <td class="td-bordered">
                    <div style="display: flex;">
                        ...
                        <div style="width: 50%;" class="div-label-left">
                            {{ str_replace(',', '.', number_format($pesagem->peso_tara, 0)) }}</div>
                    </div>
                </td>
                <td class="td-bordered">
                    <div style="display: flex;">
                        <div style="width: 50%;" class="div-label-right">Data</div>
                        <div style="width: 50%;" class="div-label-left">
                            {{ Carbon\Carbon::parse($pesagem->data_tara)->format('d/m/Y') }}</div>
                    </div>
                </td>
                <td class="td-bordered">
                    <div style="display: flex;">
